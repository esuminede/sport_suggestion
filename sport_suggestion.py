...
def sport_suggestion():
    ...
    return render_template("sport_suggestion_index.html")  # Formun olduğu sayfa
...
def chat():
    ...
    # Kullanıcının mesajı sporla ilgili mi kontrol et
